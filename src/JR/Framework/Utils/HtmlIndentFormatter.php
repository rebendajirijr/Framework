...
/**
 * Description of HtmlIndentFormatter.
 *
 * @author	RebendaJiri
 * @package JR\Framework
 */
class HtmlIndentFormatter extends Nette\Object
{
	/**
	 * Formats HTML using auto indentation.
	 * 
	 * @param string $source
	 * @return string
	 */
	public static function format($source)
	{
		...
		$fixed_uncleanhtml = self::fixNewLinesForCleanHtml((string) $source);
	...
	private static function fixNewLinesForCleanHtml($fixthistext)
	{
